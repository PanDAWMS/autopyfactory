...
'''
Version of queues handling for usage as embedded library. 
...
class StaticAPFQueue(object):
    ...
    def __init__(self, parent, config, fconfig=None):
        '''
        :param Object parent:           Calling object. 
        :param ConfigParser config:     Queue config containing only this queue info. 
        :param ConfigParser fconfig:    Parent config
        :rtype StaticAPFQueue
