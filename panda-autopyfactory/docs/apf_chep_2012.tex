...
in such a way that information can be converted internally into AutoPyFactory nomenclature. 
...
\begin{table}
   \begin{center}
      \begin{tabular}{l l}
         \hline
         \textbf{Panda}         & \textbf{AutoPyFactory}       \\
         \hline
         pending       & notready  \\ 
         defined       & notready  \\ 
         assigned      & notready  \\ 
...
\begin{table}
   \begin{center}
      \begin{tabular}{l l}
         \hline
         \textbf{Condor Local}   & \textbf{AutoPyFactory}       \\ 
         \hline
...
\begin{table}
   \begin{center}
      \begin{tabular}{l l}
         \hline
         \textbf{Globus status}   & \textbf{AutoPyFactory status}       \\ 
         \hline
         PENDING       &   pending    \\
         ACTIVE        &   running    \\
         FAILED        &   done       \\
...
%%%      \begin{tabular}{l l l}
%%%         \hline
%%%         \textbf{Condor-C/Local}      &   \textbf{Condor-G/Globus}     &   \textbf{AutoPyFactory}        \\ 
%%%         \hline
