...
setup(
    ...
    data_files=[('/usr/libexec', ['libexec/runpilot3-wrapper.sh',
                ...
                ('/usr/lib/python2.6/site-packages/autopyfactory', ['autopyfactory/apfexceptions.py',
                                                                    'autopyfactory/utils.py',
                                                                    'autopyfactory/factory.py',
                                                                    'autopyfactory/configloader.py',
                                                                    'autopyfactory/proxymanager.py',
                                                                    'autopyfactory/monitor.py',
                                                                    'autopyfactory/logserver.py',
                                                                   ]),
                ('/usr/lib/python2.6/site-packages/autopyfactory/plugins', ['autopyfactory/plugins/submit.py',
                                                                            'autopyfactory/plugins/PandaWMSStatusPlugin.py',
                                                                            'autopyfactory/plugins/CondorBatchStatusPlugin.py',
                                                                            'autopyfactory/plugins/CondorBatchSubmitPlugin.py',
                                                                            'autopyfactory/plugins/TrivialSchedPlugin.py',
                                                                           ]),
                ]
)
