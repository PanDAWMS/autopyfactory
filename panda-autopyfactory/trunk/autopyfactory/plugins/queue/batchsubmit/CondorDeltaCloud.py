...
class CondorDeltaCloud(CondorGrid):
    id = 'condordeltacloud'
    ...
    def __init__(self, apfqueue, config=None):
        ...
        super(CondorDeltaCloud, self).__init__(apfqueue, config=newqcl)
        try:
        ...
        self.log.info('CondorDeltaCloud: Object initialized.')
    ...
    def _addJSD(self):
        ...
        self.log.debug('CondorDeltaCloud.addJSD: Starting.')
        ...
        super(CondorDeltaCloud, self)._addJSD()

        self.log.debug('CondorDeltaCloud.addJSD: Leaving.')
